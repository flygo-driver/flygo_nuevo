...
class TerminosCondicionesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Text('Términos y Condiciones de FlyGo', style: text.headlineSmall?.copyWith(color: Colors.white, fontWeight: FontWeight.w800)),
          const SizedBox(height: 6),
          Text('Última actualización: 05/11/2025', style: text.bodySmall?.copyWith(color: Colors.white54)),
  ...
  static Widget _h(String t) => Padding(
        ...
        child: Text(t, style: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w800)),
      );

  static Widget _p(String t) => Padding(
        padding: const EdgeInsets.only(bottom: 6),
        child: Text(t, style: const TextStyle(color: Colors.white70, fontSize: 14, height: 1.35)),
      );
              ...
              .map((e) => Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(child: Text(e, style: const TextStyle(color: Colors.white70, fontSize: 14, height: 1.35))),
                      ],
                    ),
                  ))
              .toList(),
