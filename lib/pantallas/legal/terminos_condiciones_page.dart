  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Text('Términos y Condiciones de RAI DRIVER',
          ...
          _h('1. Quiénes somos'),
          _p('RAI DRIVER es una plataforma tecnológica operada por Open ASK Service SRL, RNC 1320-11767 (en adelante, “RAI DRIVER”, “nosotros”). '
              'RAI DRIVER **no es** una empresa de transporte: prestamos un **servicio de intermediación** digital que conecta pasajeros con conductores independientes autorizados.'),
          _h('2. Aceptación'),
          ...
          _b([
            ...
            'Instalar cámaras de seguridad internas cuando RAI DRIVER lo exija conforme a la ley vigente.',
          ]),
          ...
          _b([
            ...
            'Cuidar el vehículo y respetar la marca RAI.',
          ...
          _p('La movilidad implica riesgos inherentes (tránsito, clima, terceros). RAI DRIVER aplica medidas de seguridad, pero no puede eliminar totalmente los riesgos.'),
          _h('9. Responsabilidad y limitación'),
          _p('En la máxima medida permitida por la ley, RAI DRIVER no es responsable por: '
              ...
              'En todo caso, la responsabilidad total de RAI DRIVER se limita al monto efectivamente pagado por el servicio objeto del reclamo.'),
          ...
          _p('Menores deben viajar acompañados o con autorización del representante legal. RAI DRIVER podrá exigir documentación y cancelar solicitudes que impliquen riesgo.'),
          _h('13. Seguridad y cooperación con autoridades'),
          _p('RAI DRIVER podrá conservar y, cuando la ley lo requiera, facilitar a las autoridades información pertinente (registros, ubicaciones, comunicaciones y, si aplica, grabaciones). '
              'Hechos delictivos serán denunciados.'),
          _h('14. Contenido, marca y licencia'),
          _p('RAI DRIVER y sus logotipos son marcas protegidas. No adquieres derecho alguno sobre nuestra propiedad intelectual. '
              'Concedes a RAI DRIVER una licencia no exclusiva para tratar los contenidos que subas estrictamente para operar el servicio.'),
