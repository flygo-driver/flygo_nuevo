...
class RaiUbicacionTaxistaBanner extends StatefulWidget {
  const RaiUbicacionTaxistaBanner({super.key});

  @override
  State<RaiUbicacionTaxistaBanner> createState() =>
      _RaiUbicacionTaxistaBannerState();
}

class _RaiUbicacionTaxistaBannerState extends State<RaiUbicacionTaxistaBanner> {
  final _svc = RaiUbicacionTaxistaService.instance;
